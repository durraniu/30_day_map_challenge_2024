---
title: "Health Sites in Canada and Pakistan (Day 8: HDX)"
date: "2024-11-08"
categories: [HDX]
image: image.png
echo: false
...
#| echo: false
#| message: false
can_health <- sf::st_read(here::here("posts/day8/data/canada.geojson"), quiet = TRUE)
pak_health <- sf::st_read(here::here("posts/day8/data/pakistan.geojson"), quiet = TRUE)
